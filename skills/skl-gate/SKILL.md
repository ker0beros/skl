...
1. **Find the configs.** List `.claude/skills/*/resources/project.config.md` (every installed skl skill carries one). If there are **none**, tell the user to run `/skl-init` first (it generates them) and stop — there's nothing to set.
