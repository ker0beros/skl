...
> naming + LOC budgets — because `/skl-refactor` Phase 0 reads the constitution as its target.
...
| Size budgets | LOC ceilings per file/class/function (so skl-refactor has a measure) |
